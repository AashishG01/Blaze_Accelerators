...
## 3. Engagement & Retention Engines

### 3a. Daily Streak System 🔥

**The Problem:** Traditional banking apps suffer from low daily engagement. Users open the app only for transactions, missing opportunities to build financial habits. For first-salary earners, there is no mechanism to reinforce consistent engagement during the critical habit-forming first 90 days.

**The Solution:** A Snapchat/Duolingo-inspired daily streak system that rewards users for consistent financial engagement, creating a psychological commitment loop.
...
### 3b. Gamified Finance Academy 📚

**The Problem:** First-salary earners enter the workforce with minimal financial literacy. Concepts like TDS, CIBIL score, SIPs, and emergency funds feel intimidating. Traditional financial education is long-form, jargon-heavy, and disconnected from the user's real financial context. Users do not know what they do not know, and banks have no incentive mechanism to educate them.

**The Solution:** A Candy Crush/Duolingo-style micro-learning platform embedded directly inside the banking app, where financial concepts are broken into bite-sized modules (2–3 minutes each), organized into progressive "worlds," and unlocked sequentially as the user advances.

#### Learning Journey Structure

The learning path is organized as a visual, vertically scrolling map with winding paths connecting module nodes — directly inspired by Candy Crush level maps and Duolingo skill trees.

| World | Theme | Modules | Key Concepts |
|-------|-------|---------|--------------|
| 🌱 **Money Basics** | Foundation concepts | 4 modules | Salary slip anatomy, TDS & tax basics, bank account types, UPI & digital payments |
| 💰 **Save Smart** | Building savings habits | 4 modules | Emergency fund 101, the 50-30-20 rule, automating savings, high-yield savings accounts |
| 📈 **Invest Early** | First-time investing | 4 modules | What are mutual funds, SIP explained simply, risk vs. return, starting your first SIP |
| 💳 **Credit Decoded** | Understanding credit | 3 modules | What is CIBIL score, credit cards 101, good debt vs. bad debt |
| 🏠 **Future Planning** | Long-term goals | 3 modules | Insurance basics, rent vs. buy decision, retirement planning (yes, already!) |

**Total: 5 worlds, 18 modules, ~40–55 minutes of total content**

#### Module Experience Flow

Each module follows a consistent, engaging pattern:
...
- **Micro-learning:** Each module takes 2–3 minutes — designed for commute or break-time consumption
- **Relatable examples:** All explanations use scenarios relevant to a 22-year-old earning ₹45,000/month (e.g., "If your TDS is 5%, that means ₹2,250 is deducted before you see your salary")
- **Zero jargon on first encounter:** Every financial term is introduced with a plain-English explanation before being used
- **Visual-first:** Each content slide leads with a large emoji illustration and keeps text to ~50 words

#### Why It Matters for the Bank

- **Product Adoption Pipeline:** Each learning world maps to a bank product. Completing "Invest Early" naturally leads to starting a SIP; completing "Credit Decoded" primes the user for a pre-approved credit card. Education becomes the top of the product funnel.
- **Engagement Depth:** Users who complete learning modules spend 3× more time in the app per session, increasing cross-sell opportunities.
- **Regulatory Alignment:** RBI's financial inclusion mandates encourage banks to promote financial literacy. The Finance Academy demonstrates measurable compliance.
- **Reduced Support Costs:** Financially educated customers make fewer support calls about basic concepts (what is TDS, how does SIP work, etc.).
- **Data-Driven Personalization:** Module completion data reveals user knowledge gaps, enabling targeted product recommendations (e.g., user skipped insurance world → nudge for term life insurance).
...
| Charts | Custom HTML5 Canvas (zero dependencies) |
| Animations | CSS keyframe animations + JavaScript timers |
| Routing | Custom screen-based navigation (no router library) |

### Project Structure
```
src/
├── App.jsx                    # Screen router + global wrappers
...
├── components/
│   ├── BottomNav.jsx          # 5-tab bottom navigation (Home, Budget, Learn, AI, Profile)
...
│   ├── AccountTypeScreen.jsx  # Salary account selection
│   ├── VerificationScreen.jsx # Identity verification
│   ├── QuizScreen.jsx         # Calibrated context quiz
│   ├── DashboardScreen.jsx    # Main dashboard + streak widget
│   ├── CelebrationScreen.jsx  # Salary received celebration
│   ├── BudgetScreen.jsx       # Smart budget allocation
│   ├── AIChatScreen.jsx       # AI financial coach
...
│   └── ModuleScreen.jsx       # 📖 Module lesson + quiz player
